        ...
        <div className="container">
            <div className="row">
                <div className="col-12">
                    ...
                    <Link to={{ pathname: "https://communityimpact.com/austin/features/2016/12/14/heres-list-nonprofits-volunteer-opportunities-central-austin/"}} target="_blank" className="link" >
